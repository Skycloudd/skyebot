...
class Admin(commands.Cog):
    ...
    @commands.is_owner()
    @commands.command(
        name="reload", usage="<extension>", description="Reloads an extension"
    )
    ...
    @commands.is_owner()
    @commands.command(
        name="load", usage="<extension>", description="Loads an extension"
    )
    ...
    @commands.is_owner()
    @commands.command(
        name="unload", usage="<extension>", description="Unloads an extension"
    )
